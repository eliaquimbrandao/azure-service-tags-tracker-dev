...
⚠️ **Development Environment** - Testing new features including MongoDB integration and email subscriptions
...
git clone https://github.com/yourusername/azure-service-tags-tracker-dev.git
cd azure-service-tags-tracker-dev
```
...
Done! Your dashboard will be live at: `https://yourusername.github.io/azure-service-tags-tracker-dev`
